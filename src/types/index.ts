...
export type UpgradeId =
  // Building upgrades: {buildingId}_{1..10}
  ...
  | 'faucet_6' | 'faucet_7' | 'faucet_8' | 'faucet_9' | 'faucet_10'
  | 'dapp_1' | 'dapp_2' | 'dapp_3' | 'dapp_4' | 'dapp_5'
  | 'dapp_6' | 'dapp_7' | 'dapp_8' | 'dapp_9' | 'dapp_10'
  | 'marketing_1' | 'marketing_2' | 'marketing_3' | 'marketing_4' | 'marketing_5'
  | 'marketing_6' | 'marketing_7' | 'marketing_8' | 'marketing_9' | 'marketing_10'
  | 'spammer_1' | 'spammer_2' | 'spammer_3' | 'spammer_4' | 'spammer_5'
  | 'spammer_6' | 'spammer_7' | 'spammer_8' | 'spammer_9' | 'spammer_10'
  ...
  | 'market_maker_6' | 'market_maker_7' | 'market_maker_8' | 'market_maker_9' | 'market_maker_10'
  | 'use_case_1' | 'use_case_2' | 'use_case_3' | 'use_case_4' | 'use_case_5'
  | 'use_case_6' | 'use_case_7' | 'use_case_8' | 'use_case_9' | 'use_case_10'
  // Click upgrades
